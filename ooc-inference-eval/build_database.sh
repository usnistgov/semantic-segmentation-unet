...
image_folder="/scratch/datasets/Cooksey_HES_Cells/images/"
mask_folder="/scratch/datasets/Cooksey_HES_Cells/masks/"

#output_folder="/path/to/output/directory/where/results/are/saved"
output_folder="/home/mmajursk/Downloads/todo/ooc/"
